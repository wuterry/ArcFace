...
save_dir = 'models/softmax'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

# logging
logging.basicConfig(level=logging.INFO)
fh = logging.FileHandler('models/softmax/image-classification.log')
...
parser.add_argument('--prefix', default='models/softmax', type=str,
...
parser.add_argument('--lr-steps', default='30,60', type=str,
